...
const SignUp = () => {
  ...
  const googleError = () => alert("Error con la autenticación de Google");
  ...
  return (
    <Container component="main" maxWidth="xs">
      <Paper className={classes.paper} elevation={3}>
        ...
        <Typography component="h1" variant="h5">{isSignup ? 'Registrarse' : 'Ingresar'}</Typography>
          ...
          <Grid container justify="flex-end">
            <Grid item>
              <Button onClick={switchMode}>
                {isSignup ? 'Ya tiene una cuenta? Ingresa' : "No tiene la cuenta? Registro"}
              </Button>
            </Grid>
          </Grid>
        </form>
